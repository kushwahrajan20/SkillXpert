  ...
  return (
    <div className='max-w-7xl mx-auto p-4 mt-20'>
      ...
      <div className='flex flex-col md:flex-row gap-6'>
        ...
        {/* Lecture sidebar */}
        <div className='flex flex-col w-full md:w-2/5 boder-t md:border-t-0 md:border-l border-gray-200 md:pl-4 pt-4 md:pt-0'>
          <h2 className='font-semibold text-xl mb-4 '>Course Lecture</h2>
          <div className='flex-1 overflow-y-auto'>
            {
              courseDetails?.lectures.map((lecture) => (
                <Card key={lecture._id} className={`mb-3 hover:cursor-pointer transform transition ${lecture._id === currentLecture?._id ? 'bg-gray-200 border-2' : 'dark:bg-gray-800'}`}
                ...
                >
                  ...
                  <CardContent className="flex items-center justify-between px-4 py-1">
                    ...
                    {
                      isLectureCompleted(lecture._id) && (
                        <Badge variant={"outline"} className="bg-green-200 text-green-500">
                          Completed
                        </Badge>
                      )
                    }
